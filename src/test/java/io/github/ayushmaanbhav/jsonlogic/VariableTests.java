...
public class VariableTests {
    ...
    public void testComplexAccess() throws JsonLogicException {
        ...
        assertEquals(
            TestUtil.parseDoubleToBigDecimal(1337.0), jsonLogic.apply("{\"var\": \"users/0/followers\"}", data));
        assertEquals("Jane", jsonLogic.apply("{\"var\": \"users/1/name\"}", data));
        assertEquals(
            TestUtil.parseDoubleToBigDecimal(2048.0), jsonLogic.apply("{\"var\": \"users/1/followers\"}", data));
    }
}
